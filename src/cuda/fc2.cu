...
int main() {
    try {
        auto h_input = load_binary("../results/predictions/golden_fc1_relu.bin");
        auto h_weights = load_binary("../weights/fc2_weight.bin");
        auto h_biases = load_binary("../weights/fc2_bias.bin");
        ...
        fc2_kernel<<<numBlocks, threadsPerBlock>>>(d_input, d_weights, d_biases, d_output, 
        ...
        cout << "Verifying CUDA FC2...\n";
        verify_tensors(h_output, golden_fc2, 1e-4);
